...
function f18() {
  ...
  let pData = document.querySelector("p.p-18");
  //   console.log(pData);

  out.innerHTML = pData.getAttribute("data-b");
}
...
function f19() {
  ...
  let pData = document.querySelectorAll("p.p-19");
  let res = "";

  for (i = 0; i < pData.length; i++) {
    res += pData[i].getAttribute("data-b") + " ";
  }
  out.innerHTML = res;
}
