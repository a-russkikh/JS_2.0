...
let ar1 = ["sdf", 32, true]; // переменную обьявляем здесь!!!!
...
let ar2 = ["fewf", 324, false]; // переменную обьявляем здесь!!!!
...
let ar3 = [34, "qqq", true]; // переменную обьявляем здесь!!!!
...
function f6() {
  ...
  document.querySelector(".out-6").innerHTML = collect;
}
...
function f7() {
  ...
  document.querySelector(".out-7").innerHTML = collect;
}
...
function f8() {
  ...
  document.querySelector(".out-8").innerHTML = collect;
...
function f10() {
  ...
  collect = ar10[1] + ar10[ar10.length - 1];
  document.querySelector(".out-10").innerHTML = collect;
}
...
function f11() {
  ...
  document.querySelector(".out-11").innerHTML = collect;
}
...
function f12() {
  ...
  document.querySelector(".out-12").innerHTML = collect;
}
...
function f16() {
  let out = document.querySelector(".out-16-odd");
  let out2 = document.querySelector(".out-16-even");
  let collect = "";
  ...
  out.innerHTML = ar16_odd;
  out2.innerHTML = ar16_even;
}
