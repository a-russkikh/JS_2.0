...
function f7() {
  ...
  document.querySelector(".out-7").innerHTML = Math.pow(num, pow);
}
...
function f9() {
  appartment = +document.querySelector(".i-9").value;
  let out = document.querySelector(".out-9");
  if (appartment >= 1 && appartment <= 32) {
    out.innerHTML = 1;
  } else if (appartment >= 33 && appartment <= 43) {
    out.innerHTML = 2;
  } else if (appartment >= 44 && appartment <= 64) {
    out.innerHTML = 3;
  } else {
    out.innerHTML = 0;
  }
...
function f13() {
  inp = document.querySelector(".i-130").value;
  let out = document.querySelector(".out-13");
  out.innerHTML = typeof inp;
}
...
let num141 = document.querySelector(".i-141");
let num142 = document.querySelector(".i-142");
...
function f14() {
  num1 = +num141.value;
  num2 = +num142.value;
  type = document.querySelector(".s-143").value;
  switch (type) {
    case "+":
...
function f15() {
  let bin1 = +document.querySelector(".s-151").value;
  let bin2 = +document.querySelector(".s-152").value;
  let oper = document.querySelector(".s-153").value;
  let out = document.querySelector(".out-15");
  switch (oper) {
    case "&&":
      out.innerHTML = bin1 && bin2;
      break;
    case "||":
      out.innerHTML = bin1 || bin2;
      break;
