...
function t13() {
  ...
  let inpAll = document.querySelectorAll(".i-13");
  // console.log(inpAll[0].value);

  let collect = "";
  let k = 0;

  while (k < inpAll.length) {
    collect += inpAll[k].value = k + 1;
    k++;
  }
  // out.innerHTML = collect;
}
