...
// document.getElementById("one").innerHTML = 2019;
// Task 7.
...
// Task 8.
// Создайте div с классом one. С помощью document.querySelector запишите в данный элемент текст ''.
...
document.querySelector(".four").innerHTML = "<h4>Random text_2</h4>";
document.querySelector(".four").innerHTML +=
  "<p>Paragraph with Random text</p>";
// Task 12.
