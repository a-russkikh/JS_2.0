...
function t9() {
  b9_num = b9.filter((item, index) => {
    // console.log(index);
    if (typeof item == 'number') {
      return true;
    }
  });
  b9_string = b9.filter((item, index) => {
    // console.log(index);
