...
function f6() {
  let inp1 = document.querySelector("input.i-61").value;
  let inp2 = document.querySelector("input.i-62").value;
  let out = "";
  a6.inp1 = inp2;
  for (let key in a6) {
    out += `${key} : ${a6[key]} <br>`;
...
function f7() {
  let inp1 = document.querySelector("input.i-7").value;
  let out = 0;
...
function f8() {
  let inp1 = document.querySelector("input.i-8").value;
  let out = 0;
...
function f9() {
  let inp1 = document.querySelector("input.i-9").value;
  let out = "";
...
function f11() {
  let inp = document.querySelector("input.i-11").value;
...
function f12() {
  let inp = document.querySelector("input.i-12").value;
...
function f13() {
  ...
  for (let key in a13) {
    // console.log(a13[key], typeof a13[key], "number" == typeof a13[key]);
...
function f18() {
  let inp = document.querySelector("input.i-18").value;
  let out = "<br>";
  for (let key in a18) {
    if (key == inp) {
...
function f19() {
  let out = "<br>";
  let inp = document.querySelector("input.i-19").value;
